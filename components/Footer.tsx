      ...
      <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground max-w-xs leading-relaxed">
              Plan, generate, edit, and publish engaging content in seconds. Empowering content teams with advanced AI agents.
            </p>
            <div className="flex space-x-4">
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter/X" className="text-muted-foreground hover:text-indigo-500 transition-colors">
              ...
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="text-muted-foreground hover:text-indigo-500 transition-colors">
              ...
              <a href="https://github.com" target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="text-muted-foreground hover:text-indigo-500 transition-colors">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-muted-foreground hover:text-indigo-500 transition-colors">
          ...
          <div className="mt-12 grid grid-cols-3 gap-8 xl:col-span-2 xl:mt-0">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <Link href="/explore" className="text-sm text-muted-foreground hover:text-indigo-500 transition-colors">
                    Templates
                  </Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/#how-it-works" className="text-sm text-muted-foreground hover:text-indigo-500 transition-colors">
                    Workflow
                  </Link>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <Link href="/about" className="text-sm text-muted-foreground hover:text-indigo-500 transition-colors">
                    About Us
                  </Link>
                </li>
                <li>
                  <Link href="/blog" className="text-sm text-muted-foreground hover:text-indigo-500 transition-colors">
                    Blog
                  </Link>
                </li>
                <li>
                  <Link href="/contact" className="text-sm text-muted-foreground hover:text-indigo-500 transition-colors">
                    Contact
                  </Link>
                </li>
                <li>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <Link href="/privacy" className="text-sm text-muted-foreground hover:text-indigo-500 transition-colors">
                    Privacy Policy
                  </Link>
                </li>
                <li>
                  <Link href="/terms" className="text-sm text-muted-foreground hover:text-indigo-500 transition-colors">
                    Terms of Service
                  </Link>
                </li>
                <li>
        ...
        <div className="mt-12 border-t border-border pt-8 flex items-center justify-between">
          <p className="text-xs text-muted-foreground">
            &copy; 2026 WriteFlow AI. All rights reserved.
          </p>
